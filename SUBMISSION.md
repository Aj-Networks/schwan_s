...
Schwan's runs 16 plants and 3 corporate offices, split into 4 job groups. Skills data sits in different places, so a simple question has no answer: if the person who knows the ammonia system leaves, who else can do it?
...
- Real HR data instead of demo numbers.
- Employee-level view so a person sees their own plan.
- Bonus track: an RFID badge tap at a plant that pulls up that person's skills and what they are training toward.

## About the data

Coverage numbers, headcounts, and employee names are made up for the demo. Plant names, office locations, job groups, and business drivers (the Sioux Falls plant build-out, the CJ CheilJedang integration) are real and from public sources. The app says this on screen.

---

## Demo script (about 3 minutes)

1. **Overview, 40 seconds.** "Schwan's has 16 plants and 3 offices. Five skills are held by three people or fewer. This list is the order I would fix them in, ranked by how much it hurts, how few people hold it, and how big the gap is."
...
5. **Theme toggle and close, 20 seconds.** "No frameworks, no build, no internet needed. Four files."
